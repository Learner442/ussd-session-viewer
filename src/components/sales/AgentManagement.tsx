    ...
    try {
      const { error } = await supabase
        ...
        .insert({
          ...
          supervisor: newAgentForm.supervisor,
          initial_topup: newAgentForm.initial_topup,
          status: 'pending' as const,
          agent_id: `AGT_${Date.now()}` // Temporary ID, will be replaced by trigger
        });
      ...
      toast({
        ...
        description: `${newAgentForm.agent_name} has been added as a new sales agent.`,
      });
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      id="supervisor"
                      value={newAgentForm.supervisor}
                      onChange={(e) => setNewAgentForm(prev => ({ ...prev, supervisor: e.target.value }))}
